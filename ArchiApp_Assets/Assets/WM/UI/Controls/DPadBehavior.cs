...
namespace Assets.WM.UI
{
    ...
    public class DPadBehavior : MonoBehaviour
    {
        ...
        public void OnStickPointerDown(BaseEventData baseEventData)
        {
            ...
            m_stick.transform.position = Assets.WM.Util.Math.ToVector3(pointerEventData.position);
        }
        ...
        public void OnStickDrag(BaseEventData baseEventData)
        {
            ...
            var touchPosition = Assets.WM.Util.Math.ToVector3(pointerEventData.position);
        ...
        {
            return Assets.WM.Util.Math.ToVector2(m_stick.transform.localPosition - m_stickBasePosition);
        }
