...
using Assets.WM.UI;
using Assets.WM.CameraNavigation;
...
namespace Assets.ArchiApp.Application
{
    public class ApplicationStatePlay : ApplicationState
    {
        ...
        private void UpdateVirtualGamepadWidgetVisibility()
        {
            ...
            var cameraNavigation = GameObject.Find("CameraNavigation").GetComponent<CameraNavigation>();
            var uiManager = UIManager.GetInstance();
        ...
        public void MenuTimeButton_OnClick()
        {
            ...
            UIManager.GetInstance().OpenMenu(GameObject.Find("MenuTime").GetComponent<Assets.WM.UI.Menu>());
        }
        ...
        public void MenuLayerButton_OnClick()
        {
            ...
            UIManager.GetInstance().OpenMenu(GameObject.Find("MenuLayer").GetComponent<Assets.WM.UI.Menu>());
        }
